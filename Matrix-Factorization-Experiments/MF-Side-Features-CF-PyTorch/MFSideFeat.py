...
class MF(nn.Module):
    ...
    def __call__(self, train_x):
        ...
        # Add bias prediction and occupation-item interaction to the interaction prediction
    ...
    def loss(self, prediction, target):
        ...
        # Add up the MSE loss + user & item regularization + user & item biases regularization + occupation regularzation
