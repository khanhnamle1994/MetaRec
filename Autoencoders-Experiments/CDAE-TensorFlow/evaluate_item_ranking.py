...
def precision_recall_ndcg_at_k(k, rankedlist, test_matrix):
    """
    Function to calculate precision, recall, and NDCG metrics
    :param k: number of items to be recommended
    :param rankedlist: the list to be ranked
    :param test_matrix: the test set matrix
    :return: Precision@k, Recall@k, NDCG@k
    """
    idcg_k = 0
    dcg_k = 0
...
def map_mrr_ndcg(rankedlist, test_matrix):
    """
    Function to calculate MAP (Mean Average Precision), MRR (Mean Reciprocal Rank), and NDCG metrics
    :param rankedlist: the list to be ranked
    :param test_matrix: the test set matrix
    :return: MAP, MRR, NDCG
    """
...
def evaluate(self):
    ...
    :return: Metrics printed out to console
    """
    # Instantiate empty dictionaries/arrays to store the results
    pred_ratings_10 = {}
    pred_ratings_5 = {}
    pred_ratings = {}
    ranked_list = {}
    ...
    # Perform evaluation for every user in the test set
    for u in self.test_users:
        ...
        # Get the ranked list and predicted ratings
